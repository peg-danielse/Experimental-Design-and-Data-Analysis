...
you can improve the prediction interval by reducing the variance of the data. For example this could be done by removing the influence points that effect the linear model which we found in a). with this we get a smaller prediction interval.  
