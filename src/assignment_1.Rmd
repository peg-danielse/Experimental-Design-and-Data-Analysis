...
the test because the yield of the block is dependent of what additives
is received by each plot in the block. For a Friedman test the variable
need a similar spread across the different variable groups. However
there is not necessarily a similar spread between blocks and nitrogen so
we cannot apply a Friedman test in this case.
